...
仅在测试环境中快速部署验证功能使用, 生产环境请使用 [标准部署](https://github.com/wojiushixiaobai/docker-jumpserver)
...
docker run --name jms_all -d \
  ...
  wojiushixiaobai/jms_all:v3.10.10
```
...
# 拉取新版本镜像
docker pull wojiushixiaobai/jms_all:v3.10.10
